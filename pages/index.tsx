            ...
            <main className={styles.main}>
                ...
                <div className={styles.grid}>
                    <a href="https://www.linkedin.com/in/ivanmorgillo/" className={styles.card}>
                        <img src={"https://avatars.githubusercontent.com/hamen"}
                             width={200}
                             height={200}
                             className={styles.avatar}
                             alt={"Ivan Morgillo on a conference stage"}
                        />
                        <h2>Ivan Morgillo 🍕🤌</h2>
                    ...
                    <a href="https://www.linkedin.com/in/matteo-principe/" className={styles.card}>
                        <img src={"https://avatars.githubusercontent.com/readbeard"}
                             width={200}
                             height={200}
                             className={styles.avatar}
                             alt={"Matteo Principe hiking"}
                        />
                    ...
                    <a href="https://www.linkedin.com/in/marcocattaneo1/" className={styles.card}>
                        <img src={"https://avatars.githubusercontent.com/u/764222"}
                             width={200}
                             height={200}
                             className={styles.avatar}
                             alt={"Marco Cattaneo with palms in the background"}
                        />
